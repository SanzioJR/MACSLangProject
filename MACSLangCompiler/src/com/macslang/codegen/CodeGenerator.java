...
// Resto da implementação do CodeGenerator...
// (mantendo o mesmo código, apenas corrigindo os tipos genéricos e removendo imports não utilizados)
...
// Aqui você implementaria a geração de código para cada construção da linguagem
